...
if __name__ == '__main__':
    ...
    # test_message.append(['REQ', 'UI', 'FILESYSTEM', 'DEL_FILE', 'new_file_com'])
    ...
    # test_message.append(['REQ', 'UI', 'FILESYSTEM', 'WRITE_FILE', 'new_file_exec_change', 2, '', -2, 0])
    #
    ...
    # test_message.append(['REQ', 'UI', 'FILESYSTEM', 'CHANGE_DIR', 'new_dir'])
    # test_message.append(['REQ', 'UI', 'FILESYSTEM', 'PARENT_DIR'])
    # test_message.append(['REQ', 'UI', 'FILESYSTEM', 'WRITE_FILE', 'new_file', 2, '', -2, 0])
